...
struct Color mandelbrot(int x, int y, struct Color* palette, double re_z0, double im_z0)
{
    // c
    double re = R_MIN + x * ((R_MAX - R_MIN) / (MAX_X * 1.0));
    double im = I_MIN + y * ((I_MAX - I_MIN) / (MAX_Y * 1.0));
